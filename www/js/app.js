...
function init () {
  ...
  // sky box
  const cubTexLoader = new THREE.CubeTextureLoader()
  const texture = cubTexLoader.load([
    '../images/skyboxes/starfield/right.png',
    '../images/skyboxes/starfield/left.png',
    '../images/skyboxes/starfield/top.png',
    '../images/skyboxes/starfield/bottom.png',
    '../images/skyboxes/starfield/back.png',
    '../images/skyboxes/starfield/front.png'
  ])
  ...
  // var modelFile =
  // '../models/mmd/yousa_shiying/石英式泠鸢yousa_v1.2-Apose.pmx';
  var modelFile = '../models/mmd/hanser/Hanser β v1.0.pmx'
...
function createPlayControllerUI () {
  ...
  statsContainer.parentNode.insertBefore(
    playButton, statsContainer.nextSibling)
}
function toggleMMD () {
  if (pause) {
    pause = false
